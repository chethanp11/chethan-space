    ...
    >
      <div className="flex flex-wrap gap-2">
        {projectSections.map((section) => (
          <a key={section.href} href={section.href} className="rounded-full border border-brand-copper/30 bg-white/70 px-4 py-2 text-sm font-semibold text-brand-navy transition hover:bg-brand-sky hover:text-brand-navy dark:border-ink-700 dark:bg-ink-900/60 dark:text-ink-100 dark:hover:bg-brand-sky dark:hover:text-brand-navy">
            {section.label}
          </a>
        ))}
      </div>
